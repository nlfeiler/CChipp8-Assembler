...
void langCompile(std::vector<char> &ROMBytes, std::string outputFile, int returnCode) {
	...
	for (int i = 0; i < tokens.size(); i++) {
		...
		else if(tokens[i] == "eqSkip") opcodes.push_back(0x3000 + (getX(tokens, i) * 100) + getNN(tokens, i)); //3XNN
		else if(tokens[i] == "neqSkip") opcodes.push_back(0x4000 + (getX(tokens, i) * 100) + getNN(tokens, i)); //4XNN
		else if(tokens[i] == "regEq") opcodes.push_back(0x5000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10)); //5XY0
		else if(tokens[i] == "vxEq") opcodes.push_back(0x6000 + (getX(tokens, i) * 100) + getNN(tokens, i)); //6XNN
		else if(tokens[i] == "vxInc") opcodes.push_back(0x7000 + (getX(tokens, i) * 100) + getNN(tokens, i)); //7XNN
		else if(tokens[i] == "vxSetRegEq") opcodes.push_back(0x8000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10)); //8XY0
		else if(tokens[i] == "vxOrVy") opcodes.push_back(0x8000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10) + 1); //8XY1
		else if (tokens[i] == "vxAndVy") opcodes.push_back(0x8000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10) + 2); //8XY2
		else if (tokens[i] == "vxXorVy") opcodes.push_back(0x8000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10) + 3); //8XY3
		else if (tokens[i] == "vxIncVy") opcodes.push_back(0x8000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10) + 4); //8XY4
		else if (tokens[i] == "vxDecVy") opcodes.push_back(0x8000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10) + 5); //8XY5
		else if (tokens[i] == "vxRightShift") opcodes.push_back(0x8000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10) + 6); //8XY6
		else if (tokens[i] == "vxSubVyVx") opcodes.push_back(0x8000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10) + 7); //8XY7
		else if (tokens[i] == "vxLeftShift") opcodes.push_back(0x8000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10) + 0xE); //8XYE
		else if(tokens[i] == "vxNotEqVy") opcodes.push_back(0x9000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10)); //9XY0
		...
		else if(tokens[i] == "vxRand") opcodes.push_back(0xC000 + (getX(tokens, i) * 100) + getNN(tokens, i)); //CXNN
		else if(tokens[i] == "draw") opcodes.push_back(0xD000 + (getX(tokens, i) * 100) + (getY(tokens, i) * 10) + getN(tokens, i)); //DXYN
		else if(tokens[i] == "keyEq") opcodes.push_back(0xE000 + (getX(tokens, i) * 100) + 0x9E); //EX9E
		else if (tokens[i] == "keyNotEq") opcodes.push_back(0xE000 + (getX(tokens, i) * 100) + 0xA1); //EXA1
		else if(tokens[i] == "vxEqGetDelay") opcodes.push_back(0xF000 + (getX(tokens, i) * 100) + 0x07); //FX07
		else if(tokens[i] == "vxEqGetKey") opcodes.push_back(0xF000 + (getX(tokens, i) * 100) + 0x0A); //FX0A
		else if (tokens[i] == "delayEqVx") opcodes.push_back(0xF000 + (getX(tokens, i) * 100) + 0x15); //FX15
		else if(tokens[i] == "soundEqVx") opcodes.push_back(0xF000 + (getX(tokens, i) * 100) + 0x18); //FX18
		else if(tokens[i] == "iIncVx") opcodes.push_back(0xF000 + (getX(tokens, i) * 100) + 0x1E); //FX1E
		else if(tokens[i] == "iEqSprite") opcodes.push_back(0xF000 + (getX(tokens, i) * 100) + 0x29); //FX29
		else if(tokens[i] == "dumpVxBCD") opcodes.push_back(0xF000 + (getX(tokens, i) * 100) + 0x33); //FX33
		else if(tokens[i] == "regDump") opcodes.push_back(0xF000 + (getX(tokens, i) * 100) + 0x55); //FX55
		else if(tokens[i] == "regLoad") opcodes.push_back(0xF000 + (getX(tokens, i) * 100) + 0x65); //FX65
	}
